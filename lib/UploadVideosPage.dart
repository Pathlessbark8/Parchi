...
class _UploadVideosPageState extends State<UploadVideosPage> {
  ...
  File file;
  String videoStatus = 'Upload a video file';
  List fileTags = [];
  String fileString = '';
  bool isPopUpload = false;
  bool isUploading = false;
  String error = "";
  videosCrudMethods crudObj = new videosCrudMethods();
              ...
              onPressed: () async {
                ...
                if (isInternet) {
                  if (file != null &&
                    ...
                    try {
                      String VideosUrl = await getDownloadURL(
                          file, 'video', '${globals.title}');
                      videosUpload ob = videosUpload(
                          globals.title,
                          globals.description,
                          this.fileTags,
                          VideosUrl,
                                  ...
                                  () {
                                    if (file != null) {
                                      if (file.lengthSync() < 800000000) {
                                        videoStatus = "File uploaded";
                                        fileString = file.toString();
                                      } else {
                                        file = null;
                                        videoStatus = 'Upload a video file';
